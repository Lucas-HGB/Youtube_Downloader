...
const getMetadata = async(video_id) => {
    ...
    const youtubeDownloader = `http://ytdlpapi:8000/update/${video_id}`
...
const deleteCache = (url) =>{
    const youtubeDownloader = `http://ytdlpapi:8000/cache`
...
const updateMetadata = async (video_id) =>{
    ...
    const youtubeDownloader = `http://ytdlpapi:8000/update/${video_id}/metadata`
...
const downloadMP3 = async (video_id) =>{
    ...
    console.log('to aqui')
    const youtubeDownloader = `http://ytdlpapi:8000/downloadMP3/${video_id}`
